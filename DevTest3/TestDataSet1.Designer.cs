...
namespace DevTest3 {
    ...
    public partial class TestDataSet1 : global::System.Data.DataSet {
        ...
        public partial class userDataTable : global::System.Data.TypedTableBase<userRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public userRow AdduserRow(string password, string age, string userid) {
...
namespace DevTest3.TestDataSet1TableAdapters {
    ...
    public partial class userTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[user] WHERE (((@IsNull_password = 1 AND [password] IS NULL) OR" +
                " ([password] = @Original_password)) AND ((@IsNull_age = 1 AND [age] IS NULL) OR " +
                "([age] = @Original_age)) AND ([userid] = @Original_userid))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[user] ([password], [age], [userid]) VALUES (@password, @age, @" +
                "userid);\r\nSELECT password, age, userid FROM [user] WHERE (userid = @userid)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[user] SET [password] = @password, [age] = @age, [userid] = @userid WHERE (((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_age = 1 AND [age] IS NULL) OR ([age] = @Original_age)) AND ([userid] = @Original_userid));
SELECT password, age, userid FROM [user] WHERE (userid = @userid)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DevTest3.Properties.Settings.Default.TestConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT password, age, userid FROM dbo.[user]";
        ...
        public virtual int Delete(string Original_password, string Original_age, string Original_userid) {
        ...
        public virtual int Insert(string password, string age, string userid) {
            if ((password == null)) {
        ...
        public virtual int Update(string password, string age, string userid, string Original_password, string Original_age, string Original_userid) {
            if ((password == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string password, string age, string Original_password, string Original_age, string Original_userid) {
            return this.Update(password, age, Original_userid, Original_password, Original_age, Original_userid);
        }
    }
